...
permited=$(curl -sSL ${link}/xxlPapatzulxx/Generador-BOT/main/Bot/Control-Bot | awk '{print $1}')
 ...
 ### INTALAR VERCION DE SCRIPT
  ...
  echo -e "      Mediante  $link Autorida por @Jerry_SBG"
  echo -e "      SI DESEAS USAR EL BOTGEN CONTACTE A @Jerry_SBG"
  echo -e "\e[32m=====================================================\n\n\n\e[0m"
...
[[ $(cat < /etc/ADM-db/resell) != "@Jerry_SBG" ]] && mv /etc/ADM-db/resell /root/resell
...
msg -bar
echo -e " \033[7;49;35m ${TTini} ⚜️ BotGEN Jerry${TTcent}SBG $(cat ${CIDdir}/vercion) ⚜️ ◄◄<===   \033[0m"
msg -bar
